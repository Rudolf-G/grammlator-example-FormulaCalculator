...
namespace grammlatorExampleEvaluateNumericExpression {
    public class MySymbolInputClass: GrammlatorInputApplication<MySymbolInputClass.eSymbol> {
        ...
        //| number(double value)= 
        //|    digit(char c)
        void FirstdigitOfNumberRecognized(out double value, char c) {
            value = (int)c - (int)'0';
            }
        //|    | number(double leftvalue), digit(char rightdigit) 
        void NumberFollowedByDigitRecognized(out double value, double leftvalue, char rightdigit) {
...
s2: 
  ...
  NumberFollowedByDigitRecognized(
...
EndOfGeneratedCode:;
//| /* This is the last line of code generated by Grammlator at 15.05.2017 18:41:47 */  ; 
