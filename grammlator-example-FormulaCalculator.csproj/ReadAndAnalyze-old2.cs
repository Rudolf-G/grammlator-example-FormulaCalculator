...
// This code has been generated by Grammlator version 0:21 ( build 14.05.2017 20:50:58 +00:00)
  ...
  if (  (MySymbolInput.Symbol >= eSymbol.multOp && MySymbolInput.Symbol <= eSymbol.rightParentheses) || 
        (MySymbolInput.Symbol >= eSymbol.equalChar)) 
     {ErrorHandler(1); 
     goto x1; } 
  ...
  if (  MySymbolInput.Symbol != eSymbol.equalChar) 
     goto r11; 
  MySymbolInput.AcceptSymbol(); 
  /* State 10 (6)
  // MyGrammar= identifier(1:string identifier), equalChar, ►additiveExpression(2:double result);   */
...
r11: 
  /* reduction 11 */
  // primaryExpression(1:double value)= identifier(1:string identifier);◄ method: IdentifierInExpression
...
as15: MySymbolInput.AcceptSymbol(); 
  ...
  if (  MySymbolInput.Symbol <= eSymbol.rightParentheses || 
        (MySymbolInput.Symbol >= eSymbol.equalChar)) 
     {ErrorHandler(15); 
     goto x1; } 
  if (  MySymbolInput.Symbol == eSymbol.leftParentheses) 
...
as16: MySymbolInput.AcceptSymbol(); 
  ...
  _s.Push(9); MySymbolInput.GetSymbol(); 
  if (  MySymbolInput.Symbol <= eSymbol.rightParentheses || 
        (MySymbolInput.Symbol >= eSymbol.equalChar)) 
     {ErrorHandler(16); 
     goto x1; } 
...
EndOfGeneratedCode:;
//| /* This is the last line of code generated by Grammlator at 15.05.2017 18:37:45 */  ; 
            }
        }
