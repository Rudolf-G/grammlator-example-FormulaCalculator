...
namespace GrammlatorRuntime
{
        ...
        : IGrammlatorInput<TTypeOfOutputSymbols> where TTypeOfOutputSymbols : IComparable  /* enum */
    {
        ...
        /// </param>
        protected GrammlatorInput(MultiTypeStack attributeStack)
        {
            _a = attributeStack;
            Accepted = true;
        }
        ...
        /// <summary>
        /// <para>When <see cref="Accepted"/> is false, then calls to <see cref="FetchSymbol"/> do nothing and </para>
        ...
        /// <para>Else calls to <see cref="AcceptSymbol"/> do nothing and calls to <see cref="FetchSymbol"/> retrieve the next symbol and set accepted to false. </para>
        /// </summary>
        ...
        /// </summary>
        protected MultiTypeStack AttributesOfSymbol
        {
            get;
            // private set{ _AttributesOfSymbol = value; }
        } = new MultiTypeStack(10);

        /// <summary>
        /// Sets accepted=true, copies the AttributesOfSymbol to the attribute stack and clears AttributesOfSymbol. 
    ...
    public abstract class GrammlatorApplication
    {
        ...
        /// <summary>
        /// The state stack is used by grammlator generated code to push integer values assigned to states.
        /// When a definition is recognized, processing continues at a state (label) depending on the contents
        /// of the state stack. By optimization the same number may be assigned to different states.
        /// There may be states with no assigned number. Each parser / lexer may have its own state stack.
        ...
        {
            _a = new MultiTypeStack(initialSizeOfAttributeStack);
        ...
        : GrammlatorInput<TTypeOfOutputSymbols> where TTypeOfOutputSymbols : IComparable  /* enum */
    {
        ...
        /// </param>
        protected GrammlatorInputApplication(MultiTypeStack attributeStack, Stack<Int32> stateStack)
    ...
    public static class StackExtensions
    {
        ...
        public static T Pop<T>(this Stack<T> stack, Int32 count)
        {
            Debug.Assert(stack != null);
            for (Int32 i = 1; i < count; i++) // count-1 Pop
                stack.Pop();
            return stack.Pop(); // one additional Pop
        }
    }
    ...
    public class MultiTypeStack
    {
        ...
        internal Int32 TopIndex { get; set; }
        ...
        /// <summary>
        /// remove count elements from the stack: clear theelements and then decrement <see cref="TopIndex"/>
        /// </summary>
        ...
        /// <summary>
        /// Copy <paramref name="count"/> attributes from <paramref name="sourceStack"/> and remove them from the source
        /// </summary>
        /// <param name="sourceStack">stack to copy from</param>
        /// <param name="count">number of elements to remove &gt;= 0</param>
        public void CopyAndRemoveFrom(MultiTypeStack sourceStack, Int32 count)
        {
            Allocate(count);
        ...
        /// <summary>
        /// Copy and remove all attributes from <paramref name="sourceStack"/>
        /// </summary>
        /// <param name="sourceStack">stack to copy from</param>
